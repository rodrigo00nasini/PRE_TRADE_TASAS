...
def scoring(rates_spread_ts,short_w,long_w,dispersion_function):
    ...
    data["DISPERSION_METRIC_SHORT"] = data["spread"].rolling(window=short_window).apply(dispersion_function)
    
    data["DISPERSION_METRIC_LONG"] = data["spread"].rolling(window=long_window).apply(dispersion_function)
   
    data["SCORE"] = 0

    # Compare the short-term and long-term variances
    data.loc[data["DISPERSION_METRIC_SHORT"] >data["DISPERSION_METRIC_LONG"].quantile(0.50), "SCORE"] += 1
    
    data.loc[data["DISPERSION_METRIC_SHORT"] > data["DISPERSION_METRIC_LONG"].quantile(0.65), "SCORE"] += 1
         
    data.loc[data["DISPERSION_METRIC_SHORT"] >data["DISPERSION_METRIC_LONG"].quantile(0.80), "SCORE"] += 1
